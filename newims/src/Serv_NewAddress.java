...
public class Serv_NewAddress extends HttpServlet
{
	...
	con=ConnectionProvider.getConnection();
            ...
            servletoutputstream.println("<h1><center><blink>New Address Screen</blink></center></h1><body style='background-color:#d3d3d3;' text=#FF0000><h3>Adding new address to '" + s + "'<b>Address Box</b></h3><br>");

...
public class Serv_Inbox extends HttpServlet
{
	...
	con=ConnectionProvider.getConnection();
            ...
            servletoutputstream.println("<html><head><title>Welcome to College Mailing Chatting System</title>");
			...
			//servletoutputstream.println("<body bgcolor=white text=blue>");
            servletoutputstream.println("<body style='background-color:#d3d3d3;' text=#000000>");
            ...
            servletoutputstream.println("<pre>                              <font face=verdana color=#000000>select a folder then go for MoveTo</font></pre>");
            resultset1.close();
            st.close();
            servletoutputstream.println("<br><table border=2 cellpadding=4 cellspacing=5 width=80%><TR bgcolor=#7F7F7F><th><font color=#FFFFFF>Status</th><TH><font color=#FFFFFF>From</TH><TH><font color=#FFFFFF>Subject</Th><TH><font color=#FFFFFF>Date</TH></TR>");

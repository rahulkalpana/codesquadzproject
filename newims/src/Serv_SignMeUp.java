        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            } else
            {
                ...
                sos.println("<html><body bgcolor=white background='INDTEXTB.JPG' text=blue><h1>Congrats ! <br>for sucessfully registering urself with College Mailing Chatting System </h1></body></html>");

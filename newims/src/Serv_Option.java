...
public class Serv_Option extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            servletoutputstream.println("<html><head><title>Welcome to College Mailing Chatting System></title></head>");
            ...
            servletoutputstream.println("<body style='background-color:#d3d3d3;' text=black><h1><center><blink>Change Password Screen</blink></center></h1>");
            ...
            servletoutputstream.println("<b>New PassWord </b>      :<input type=password name=np value='' required><br><br>");

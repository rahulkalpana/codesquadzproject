	...
	con=ConnectionProvider.getConnection();
		...
		System.out.println("name of the file into serv_send>>>>>>>>>>>>>>>>>"+mch);
                    ...
                    if(j > 0)
                    	...
                    	servletoutputstream.println("<html><body style='background-color:d3d3d3;' text=#000000><font color=blue><h3><i>Message has been sent to " + str1 + " </i></h3></font>");
                    st2.close();
                }
            }
            str1 = "";
            ...
            if(k > 0)
            	...
            	servletoutputstream.println("<html><body style='background-color:d3d3d3;' text=#000000><font color=blue><h3><i>Message has been sent to " + s2 + " </i></h3></font>");
            st3.close();
